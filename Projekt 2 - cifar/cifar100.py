...
# Załadowanie CIFAR-100
(x_train, y_train), (x_test, y_test) = keras.datasets.cifar100.load_data()

# Normalizacja wartości pikseli do zakresu [0,1]
x_train, x_test = x_train / 255.0, x_test / 255.0

# Konwersja etykiet na one-hot encoding - 100 klas
...
def create_model():
    model = keras.Sequential([
        layers.Conv2D(32, (3,3), activation='relu', padding='same', kernel_regularizer=keras.regularizers.l2(0.001), input_shape=(32,32,3)),
