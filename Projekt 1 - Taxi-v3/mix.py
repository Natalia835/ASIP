...
def study_hyperparameters():
    max_steps_2 = [50, 100, 300]
    episodes_2 = [500, 1000, 1500]

    for max_steps in max_steps_2:
        for episodes in episodes_2:
            print(f"\nTrening agenta: max steps={max_steps}, episodes={episodes}")
